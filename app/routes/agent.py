...
async def generate_legal_pleading(
    ...
    try:
        ...
        try:
            ...
            "اكتب نقاط قسمي «الدفع الشكلي» و«الدفع الموضوعي» بتعداد عربي نصي متسلسل بهذا الشكل: أولاً: … ثانياً: … ثالثاً: …؛ دون استخدام أرقام غربية أو شرطات. اجعل عناوين التعداد غامقة وتحتها خط باستخدام HTML (مثال: <u><strong>أولاً:</strong></u>)، وافصل كل نقطة في سطر مستقل.\n"
