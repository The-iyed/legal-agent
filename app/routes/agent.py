...
async def generate_legal_pleading(
    ...
    try:
        ...
        try:
            ...
            "قبل تعداد نقاط «الدفع الشكلي» أدرِج سطراً مرجعياً نظامياً ينتهي بعبارة ‘للأسباب التالية:’ بصياغة مثل: استنادًا إلى المادة (5) من نظام المرافعات أمام ديوان المظالم، والمادة (3) من لائحته التنفيذية، وكذلك المادة (76) من نظام المرافعات الشرعية، والمادة (80) من لائحته التنفيذية، ندفع بعدم قبول الدعوى شكلاً، وذلك للأسباب التالية:. ثم ابدأ التعداد.\n"
            "وقبل تعداد نقاط «الدفع الموضوعي» أدرِج سطراً مرجعياً مماثلاً يُناسب الموضوع وينتهي بعبارة ‘للأسباب التالية:’.\n"
