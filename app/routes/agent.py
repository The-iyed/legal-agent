...
async def generate_legal_pleading(
    ...
    try:
        ...
        try:
            ...
            "اكتب نقاط قسمي «الدفع الشكلي» و«الدفع الموضوعي» بتعداد عربي نصي متسلسل بهذا الشكل: أولاً: … ثانياً: … ثالثاً: …؛ دون استخدام أرقام غربية أو شرطات. كل نقطة في سطر مستقل مع صياغة موجزة.\n"
