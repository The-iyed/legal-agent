...
async def generate_legal_pleading(
    ...
    try:
        ...
        try:
            ...
            "أنتج المحتوى فقط (دون أي ترويسة/عنوان في الأعلى) بثلاثة أقسام مرتبة بعناوين غامقة فقط (دون استخدام #):\n"
            "1) **أولاً: الوقائع** — تلخيص موجز (2–4 أسطر) عن لائحة الدعوى المقدّمة من المدعي وطلباته.\n"
            "2) **ثانياً: الدفع الشكلي**\n"
            "3) **ثالثاً: الدفع الموضوعي**\n"
